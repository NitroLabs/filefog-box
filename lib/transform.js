...
transform.getFileInformation = function (file_response){
    ...
    transform.download_url = 'https://api.box.com/2.0/files/'+transform.identifier+'/content'
...
transform.searchFiles = function(items_response){
    var self = this;
    var transform = {};
    ...
    var limit = items_response.limit;
    var offset = items_response.offset;
    var new_offset = limit+offset;
    if (new_offset<items_response.total_count){
        transform.page_token = new_offset;
    }
